CREATE OR REPLACE TABLE IF NOT EXISTS MEMBER(
	...
	USER_ROLE VARCHAR(20) DEFAULT 'normal',
	CREATE_TIME TIMESTAMP NOT NULL,
	UPDATE_TIME TIMESTAMP
);

CREATE OR REPLACE INDEX IF NOT EXISTS IDX_1 ON MEMBER(CID);
...
CREATE OR REPLACE TABLE IF NOT EXISTS TICKET(
...
CREATE OR REPLACE INDEX IF NOT EXISTS IDX_1 ON TICKET(TICKET_NO,CID,STORE_NO,ITEM_NO,ORDER_NO,TICKET_DATE);
...
CREATE OR REPLACE INDEX IF NOT EXISTS IDX_1 ON PRODUCT(ITEM_NO);
